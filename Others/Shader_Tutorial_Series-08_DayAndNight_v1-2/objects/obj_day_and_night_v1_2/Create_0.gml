...
//-----------------------------------------------------------------------------
title_text	= @"Day and Night Cycle v1.2
				with brt/con/sat
				overlay colour & lights";

info_text	= @"Day and Night Cycle v1.2:
				...
				Also in version 1.2 I added lights";
...
#region GUI: 
//-----------------------------------------------------------------------------
slider_set_caption(1, "stength");
slider_set_draw_value(1, false);

toggle_set_caption(0, 0, "combined");
toggle_set_caption(1, 0, "sprite 1");
toggle_set_caption(1, 1, "sprite 2");
toggle_set_caption(1, 2, "sprite 3");
toggle_set_caption(1, 3, "sprite 4");
toggle_set_caption(1, 4, "sprite 5");
#endregion
//-----------------------------------------------------------------------------
