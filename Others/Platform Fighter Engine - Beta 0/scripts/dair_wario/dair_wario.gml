	...
	switch(_phase)
		...
		case 0:
			...
			if (attack_frame == 0)
				...
				attack_phase++;
				attack_frame = 14;
				var _hitbox = create_melee(0, 28, 0.6, 1, 1, 6, 0, 2, 270, 13, HITBOX_SHAPE.square, 0, FLIPPER.autolink_center);
		...
		case 1:
			...
			if (attack_frame == 2)
				...
				var _hitbox = create_melee(0, 28, 0.6, 1.1, 4, 6, 1, 12, 45, 3, HITBOX_SHAPE.square, 1);
