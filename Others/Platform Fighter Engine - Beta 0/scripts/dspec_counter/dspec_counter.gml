	...
	switch(_phase)
		...
		case 0:
			...
			if (attack_frame == 0)
				...
				attack_phase++;
				attack_frame = 20;
				hurtbox_set_inv(hurtbox, INV.counter, 20);
				}
		...
		case PHASE.counter:
			...
			attack_phase = 3;
			attack_frame = 30;
			hurtbox_set_inv(hurtbox, INV.invincible, 36);
			set_speed(0, 0, false, false);
			//VFX
			var _fx = create_fx(spr_dust_dash, 1, 0, 33, x, bbox_bottom - 1, 2, 0, "FX_Layer_Below");
			_fx.fx_xs = 2 * facing;
			create_fx_action_lines(30, x, y, irandom(10), "FX_Layer");
			create_fx(spr_hit_fx_counter, 1, 0, 35, x, y, 2, 0, "FX_Layer");
			fade_value = 0.0;
		...
		case 3:
			...
			if (attack_frame == 24)
				{
				anim_frame = 7;
				var _hitbox = create_melee(36, 0, 1, 1.9, 7, 10, 1, 15, 40, 7, HITBOX_SHAPE.circle, 0);
