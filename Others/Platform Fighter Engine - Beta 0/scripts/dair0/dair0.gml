	...
	switch(_phase)
		...
		case 0:
			...
			if (attack_frame == 0)
				...
				attack_phase++;
				attack_frame = 4;
				var _hitbox = create_melee(0, 20, 0.1, 0.4, 8, 6, 1.2, 15, 280, 3, HITBOX_SHAPE.square, 0);
				hitbox_set_property(_hitbox, HITBOX_PROPERTY.hit_fx_style, HIT_FX.explosion);
				...
				create_melee(0, 10, 0.6, 0.7, 8, 5, 0.7, 5, 285, 5, HITBOX_SHAPE.square, 0, FLIPPER.from_player_center_horizontal);
				}
			break;
			}
		//Active -> Endlag
