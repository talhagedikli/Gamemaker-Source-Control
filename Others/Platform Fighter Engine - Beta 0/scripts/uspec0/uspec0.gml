	...
	switch(_phase)
		...
		case 0:
			...
			if (attack_frame == 0)
				...
				attack_phase++;
				attack_frame = 8;
				var _hitbox = create_magnetbox(20, 0, 0.6, 0.6, 5, 4, 16, -32, 8, 2, HITBOX_SHAPE.circle, 0);
				hitbox_set_property(_hitbox, HITBOX_PROPERTY.hit_fx_style, HIT_FX.normal_weak);
				hurtbox_set_inv(hurtbox, INV.superarmor, 4);
				}
			break;
			}
		//Active -> Endlag
		case 1:
			...
			if (attack_frame % 2 == 0)
				...
				var _hitbox = create_magnetbox(10, -10, 0.6, 0.6, 1, 4, 16, -32, 8, 3, HITBOX_SHAPE.circle, 1);
				hitbox_set_property(_hitbox, HITBOX_PROPERTY.hit_fx_style, HIT_FX.normal_weak);
				}
			//Final hitbox
			if (attack_frame == 0)
				...
				attack_phase++;
				attack_frame = 15;
				var _hitbox = create_melee(10, -20, 0.4, 0.4, 3, 12, 0.7, 20, 55, 4, HITBOX_SHAPE.circle, 2);
