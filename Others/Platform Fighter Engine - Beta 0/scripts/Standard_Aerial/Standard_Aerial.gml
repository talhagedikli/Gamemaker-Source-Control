...
if (!jump_is_midair_jump)
	...
	if (abs(vsp) < 1)
		{
		continue_anim_loop(my_sprites[? "JumpMid"]);
		}
	//Falling
	else if (vsp >= 1)
		{
		continue_anim_loop(my_sprites[? "JumpFall"]);
		}
	//Rising
	else if (vsp <= 1)
		{
		continue_anim_loop(my_sprites[? "JumpRise"]);
		}
	//Fastfalling
	if (vsp >= fast_fall_speed)
		{
		continue_anim_loop(my_sprites[? "Fastfall"]);
		}
	}
else
	{
	...
	if (abs(vsp) < 1)
		{
		continue_anim_loop(my_sprites[? "DJumpMid"]);
		}
	//Falling
	else if (vsp >= 1)
		{
		continue_anim_loop(my_sprites[? "DJumpFall"]);
		}
	//Rising
	else if (vsp <= 1)
		{
		continue_anim_loop(my_sprites[? "DJumpRise"]);
		}
	//Fastfalling
	if (vsp >= fast_fall_speed)
		{
		continue_anim_loop(my_sprites[? "DFastfall"]);
		}
	}
#endregion
