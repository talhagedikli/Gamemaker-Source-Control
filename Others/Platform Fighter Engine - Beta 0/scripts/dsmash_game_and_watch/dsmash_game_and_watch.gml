	...
	switch(_phase)
		...
		case 1:
			...
			if (attack_frame == 0)
				...
				var _hitbox = create_melee(0, 16, 1, 0.5, _damage, 7, 1, 7, 20, 2, HITBOX_SHAPE.square, 0, FLIPPER.from_player_center_horizontal);
				...
				var _hitbox = create_melee(64, 16, 0.5, 0.5, _damage, 10, 1.1, 7, 80, 2, HITBOX_SHAPE.square, 0);
				_hitbox.hit_sfx = snd_hit_strong;
				_hitbox.hit_fx_style = HIT_FX.normal_strong;
				var _hitbox = create_melee(-64, 16, 0.5, 0.5, _damage, 10, 1.1, 7, 100, 2, HITBOX_SHAPE.square, 0);
				_hitbox.hit_sfx = snd_hit_strong;
				_hitbox.hit_fx_style = HIT_FX.normal_strong;
				camera_shake(0, 5);
				}
