	...
	switch(_phase)
		...
		case 0:
			...
			if (attack_frame == 0)
				...
				//Initial hit
				create_melee(16, 0, 0.4, 0.7, 1, 10, 0.1, 4, 65, 1, HITBOX_SHAPE.circle, 0, FLIPPER.toward_player_center_horizontal);
		...
		case 1:
			...
			if (attack_frame % 3 == 0)
				...
				var _hitbox = create_magnetbox(16, -4, 0.4, 0.9, 1, 4, 13, -24, 15, 1, HITBOX_SHAPE.circle, 1);
		...
		case 2:
			...
			if (attack_frame == 16)
				{
				anim_frame = 9;
				var _hitbox = create_melee(20, -4, 0.8, 0.5, 7, 12, 0.7, 25, 45, 3, HITBOX_SHAPE.circle, 2);
