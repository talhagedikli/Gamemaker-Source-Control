	...
	switch(_phase)
		...
		case 0:
			...
			if (state_frame == 0)
				...
				//Next phase
				state_phase++;
				state_frame = parry_active;
				//Invulnerability
				hurtbox_set_inv(hurtbox, INV.parry, parry_active + 1);
				}
			break;
			}
		case 1:
		...
		case PHASE.parry:
			...
			hurtbox_set_inv(hurtbox, INV.invincible, parry_invincible_time);
			if (state_frame > 14)
				anim_frame = 6;
			if (state_frame == 13)
				anim_frame = 7;
