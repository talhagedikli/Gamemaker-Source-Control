	...
	switch(_phase)
		...
		case 0:
			...
			if (attack_frame == 0)
				{
				anim_frame = 4;
				var _hitbox = create_melee(34, 16, 0.6, 0.5, 17, 5, 1.3, 18, 45, 5, HITBOX_SHAPE.circle, 0);
				...
				var _hitbox = create_melee(32, -4, 0.7, 0.9, 12, 5, 1.3, 18, 45, 5, HITBOX_SHAPE.circle, 0);
				_hitbox.hit_fx_style = HIT_FX.normal_strong;
