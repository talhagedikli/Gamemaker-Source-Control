	...
	switch(_phase)
		...
		case 0:
			...
			if (attack_frame == 0)
				...
				var _hitbox = create_melee(20, 0, 0.5, 0.3, 2, 5, 0, 3, 75, 4, HITBOX_SHAPE.circle, 0);
		...
		case 3:
			...
			if (attack_frame == 0)
				...
				var _hitbox = create_magnetbox(20, 0, 0.7, 0.3, 2, 5, 14, 5, 16, 4, HITBOX_SHAPE.circle, 1);
		...
		case 6:
			...
			if (attack_frame == 0)
				...
				var _hitbox = create_melee(30, -5, 0.7, 0.3, 9, 10, 0.3, 6, 40, 4, HITBOX_SHAPE.circle, 2);
