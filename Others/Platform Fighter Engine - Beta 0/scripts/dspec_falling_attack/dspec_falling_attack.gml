	...
	switch(_phase)
		...
		case 0:
			...
			if (attack_frame == 0)
				...
				attack_phase++;
				attack_frame = 90;
				var _hitbox = create_melee(16, 32, 0.6, 0.6, 7, 6, 1, 10, 290, 90, HITBOX_SHAPE.circle, 0);
		...
		case 1:
			...
			//Speed Values
			set_speed(6 * facing, 20, false, false);
			...
			if (on_ground())
				...
				var _hitbox = create_melee(0, 16, 1, 0.5, 7, 16, 0.3, 20, 55, 7, HITBOX_SHAPE.circle, 1);
				attack_phase = 2;
				attack_frame = 20;
				}
