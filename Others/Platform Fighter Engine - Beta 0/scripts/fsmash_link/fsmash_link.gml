...
if (run)
	...
	switch(_phase)
		...
		case 1:
			...
			if (attack_frame == 1)
				{
				set_speed(3 * facing, 0, true, true);
				anim_frame = 7;
				//VFX
			...
			if (attack_frame == 0)
				...
				if (damage == 0)
					...
					var _proj = create_projectile(72, 0, 0.5, 0.1, _damage, 5, 0.2, 0, _lifetime, HITBOX_SHAPE.circle, _speed, 0);
					...
					_proj.hit_fx_style = HIT_FX.slash;
					}
					
				//Weak Hitbox
				var _damage = calculate_smash_damage(7);
				var _hitbox = create_melee(36, 0, 1.1, 0.5, _damage, 6, 0, 7, 60, 2, HITBOX_SHAPE.circle, 0);
				...
				var _hitbox = create_melee(80, -4, 0.4, 0.4, _damage, 9, 1, 12, 45, 2, HITBOX_SHAPE.circle, 0, FLIPPER.sakurai);
		...
		case 3:
			...
			if (attack_frame == 0)
				...
				var _hitbox = create_melee(70, -8, 0.8, 0.7, _damage, 10, 1.3, 15, 45, 2, HITBOX_SHAPE.circle, 1);
				...
				var _hitbox = create_melee(28, 4, 1, 0.5, _damage, 10, 1.2, 12, 45, 2, HITBOX_SHAPE.circle, 1);
				_hitbox.hit_fx_style = [HIT_FX.normal_strong, HIT_FX.slash];
				_hitbox.hit_sfx = snd_hit_strong;
				_hitbox.hitstun_scaling = 0.5;
				_hitbox.knockback_state = PLAYER_STATE.in_balloon;
				attack_phase++;
