...
my_attacks[? "DashA" ] = dashattack_claw;
my_attacks[? "Ftilt" ] = ftilt_byleth;
my_attacks[? "Utilt" ] = utilt_marth;
...
my_attacks[? "Nair"	 ] = nair_cloud;
my_attacks[? "Fair"	 ] = fair_cloud;
my_attacks[? "Bair"	 ] = bair_joker;
my_attacks[? "Uair"	 ] = uair_cloud;
my_attacks[? "Dair"	 ] = dair_shulk;
			 
my_attacks[? "Nspec" ] = nspec_bow;
my_attacks[? "Fspec" ] = fspec_corrin;
my_attacks[? "Uspec" ] = uspec0;
my_attacks[? "Dspec" ] = dspec_flip_jump;
...
my_sprites[? "Entrance"	] = define_anim(spr_entrance0, define_anim(spr_idle0));
