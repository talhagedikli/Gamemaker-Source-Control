...
test[6][0] = "bars number ";
test[6][1] = instance_number(objBars);

test[7][0] = "flashdur ";
test[7][1] = control.flashDur;

test[8][0] = "bars number ";
test[8][1] = instance_number(objBars);
