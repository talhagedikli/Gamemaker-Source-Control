/// @description iui_button(x, y, w, h, string)
/// @param x
/// @param  y
/// @param  w
/// @param  h
/// @param  string
function iui_button(argument0, argument1, argument2, argument3, argument4) {
	/**
	...
	**/
	...
	// label
	iui_align_center();
	draw_text_colour(argument0 + (argument2 >> 1), argument1 + (argument3 >> 1), string_hash_to_newline(LABEL), iuiColButtonLabel, iuiColButtonLabel, iuiColButtonLabel, iuiColButtonLabel, 1);
	iui_align_pop();
