/// @description iui_tab(x, y, w, h, array_of_string, tab_index, trim_mode)
/// @param x
/// @param  y
/// @param  w
/// @param  h
...
/// @param  tab_index
/// @param  trim_mode
function iui_tab(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
	/**
	    Makes tabs!
	...
	**/
	...
	for (i = 0; i < numTabs; i++)
	{
	    ...
	    // Tab label
	    tabLabelWid = string_width(string_hash_to_newline(tmpLabel));
	    if (tabLabelWid > tabW)
	    {
	        if (tabCurrent != i)
	        {
