/// @description tween_quartic_out_output_01(input_value, input_range_min, input_range_max);
/// @param input_value
/// @param input_range_min
/// @param input_range_max
function tween_quartic_out_output_01(argument0, argument1, argument2) {
	/*
	_______________________________________________________________________________
	INFO:
	-------------------------------------------------------------------------------
	This script remaps/tweens an input value from an input range
	to an output range of 0 to 1 in a "quartic out" fashion: fast -> slow
	...
	in_value /= in_range;
	in_value--;
	return -(in_value * in_value * in_value * in_value - 1); */
