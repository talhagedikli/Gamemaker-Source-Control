/// @description tween_cubic_in_input_01(input_value, output_range_min, output_range_max);
/// @param input_value
/// @param output_range_min
/// @param output_range_max
function tween_cubic_in_input_01(argument0, argument1, argument2) {
	/*
	_______________________________________________________________________________
	INFO:
	-------------------------------------------------------------------------------
	This script remaps/tweens an input value from an input range of 0 to 1
	to an output range in a "cubic in" fashion: slow -> fast
	...
	// Short version:
	return (argument2 - argument1) * argument0 * argument0 * argument0 + argument1;
