/// @description tween_cubic_out_input_01(input_value, output_range_min, output_range_max);
/// @param input_value
/// @param output_range_min
/// @param output_range_max
function tween_cubic_out_input_01(argument0, argument1, argument2) {
	/*
	...
	return (argument2 - argument1) * (in_value * in_value * in_value + 1) + argument1;
