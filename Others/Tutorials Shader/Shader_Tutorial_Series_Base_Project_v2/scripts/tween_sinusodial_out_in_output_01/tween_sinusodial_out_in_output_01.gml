/// @description tween_sinusodial_out_in_output_01(input_value, input_range_min, input_range_max);
/// @param input_value
/// @param input_range_min
/// @param input_range_max
function tween_sinusodial_out_in_output_01(argument0, argument1, argument2) {
	/*
	_______________________________________________________________________________
	INFO:
	-------------------------------------------------------------------------------
	This script remaps/tweens an input value from an input range
	to an output range of 0 to 1 in a a "sinusodial out" fashion: slow -> fast -> slow
	...
	return -0.5 * (cos(3.14159265359 * in_value / in_range) - 1); */


	// Short version:
	return -0.5 * (cos(3.14159265359 * (argument0 - argument1) / (argument2 - argument1)) - 1);
