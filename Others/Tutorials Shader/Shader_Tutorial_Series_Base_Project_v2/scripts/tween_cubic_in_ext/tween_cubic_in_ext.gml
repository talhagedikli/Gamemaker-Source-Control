/// @description tween_cubic_in_ext(input_value, input_range_min, input_range_max, output_range_min, output_range_max);
/// @param input_value
/// @param input_range_min
/// @param input_range_max
/// @param output_range_min
/// @param output_range_max
function tween_cubic_in_ext(argument0, argument1, argument2, argument3, argument4) {
	/*
	_______________________________________________________________________________
	INFO:
	-------------------------------------------------------------------------------
	This script remaps/tweens an input value from an input range to an output range
	in a "cubic in" fashion: slow -> fast
	...
	in_value /= in_range;
	return out_range * in_value * in_value * in_value + out_min; */

	// Short version:
	var in_value = (argument0 - argument1) / (argument2 - argument1);
	return (argument4 - argument3) * in_value * in_value * in_value + argument3;
