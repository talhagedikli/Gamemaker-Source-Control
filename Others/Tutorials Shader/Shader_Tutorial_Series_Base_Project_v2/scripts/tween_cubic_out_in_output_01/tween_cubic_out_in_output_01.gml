/// @description tween_cubic_out_in_output_01(input_value, input_range_min, input_range_max);
/// @param input_value
/// @param input_range_min
/// @param input_range_max
function tween_cubic_out_in_output_01(argument0, argument1, argument2) {
	/*
