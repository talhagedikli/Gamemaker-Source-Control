/// @description tween_quadratic_out_in_output_01(input_value, input_range_min, input_range_max);
/// @param input_value
/// @param input_range_min
/// @param input_range_max
function tween_quadratic_out_in_output_01(argument0, argument1, argument2) {
	/*
	...
	// Short version:
	var in_value = (argument0 - argument1) / ((argument2 - argument1) / 2);
	if (in_value < 1)
		return  0.5 * in_value * in_value;
	in_value--;
		return -0.5 * (in_value * (in_value - 2) - 1);
