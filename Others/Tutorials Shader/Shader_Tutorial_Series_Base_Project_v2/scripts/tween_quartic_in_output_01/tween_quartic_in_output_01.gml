/// @description tween_quartic_in_output_01(input_value, input_range_min, input_range_max);
/// @param input_value
/// @param input_range_min
/// @param input_range_max
function tween_quartic_in_output_01(argument0, argument1, argument2) {
	/*
	_______________________________________________________________________________
	INFO:
	-------------------------------------------------------------------------------
	This script remaps/tweens an input value from an input range
	to an output range of 0 to 1 in a "quartic in" fashion: slow -> fast
	...
	in_value /= in_range;
	return in_value * in_value * in_value * in_value; */
