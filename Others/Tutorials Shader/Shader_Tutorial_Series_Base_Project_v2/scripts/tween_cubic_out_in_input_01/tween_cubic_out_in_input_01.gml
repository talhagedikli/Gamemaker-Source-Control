/// @description tween_cubic_out_in_input_01(input_value, output_range_min, output_range_max);
/// @param input_value
/// @param output_range_min
/// @param output_range_max
function tween_cubic_out_in_input_01(argument0, argument1, argument2) {
	/*
	_______________________________________________________________________________
	INFO:
	-------------------------------------------------------------------------------
	This script remaps/tweens an input value from an input range of 0 to 1
	to an output range in a "cubic out/in" fashion: slow -> fast -> slow
	...
	if (in_value < 1)
	return (argument2 - argument1) / 2 * in_value * in_value * in_value       + argument1;
	in_value -= 2;
	return (argument2 - argument1) / 2 * (in_value * in_value * in_value + 2) + argument1;
