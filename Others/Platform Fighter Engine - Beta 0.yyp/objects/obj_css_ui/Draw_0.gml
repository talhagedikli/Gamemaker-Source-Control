...
if (state == CSS_STATE.normal)
	...
	draw_set_alpha(1);
	for(var i = 0; i < min(replay_list_display_size, array_length_1d(replay_list)); i++)
		{
	...
	var _c = $666666;
	var _percent = (replay_scroll / min(array_length_1d(replay_list) - replay_list_display_size, array_length_1d(replay_list)));
	...
	draw_text(560, _y + 48 + (24 * 0), global.match_stock);
	draw_text(560, _y + 48 + (24 * 1), global.match_time);
	draw_text(560, _y + 48 + (24 * 2), global.match_stamina);
