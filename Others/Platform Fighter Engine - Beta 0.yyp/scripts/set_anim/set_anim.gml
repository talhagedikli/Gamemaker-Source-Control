///@func set_anim(sprite/defined_animation,[frame/is_finish],[speed],[scale],[angle],[color],[alpha],[offsetx],[offsety],[loop],[finish_anim])
...
function set_anim() {
	...
	if (is_array(argument[0]))
		...
		if (_array[ANIMATION._FLAG_] == undefined)
			...
			var _a = _array[irandom(array_length_1d(_array) - 1)];
