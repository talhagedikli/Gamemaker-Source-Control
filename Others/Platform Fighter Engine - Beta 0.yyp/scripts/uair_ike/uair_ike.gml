		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					attack_phase++;
					attack_frame = 6;
					var _hitbox = create_melee(30, -38, 1.1, 1.6, 7, 8, 0.9, 8, 110, 3, HITBOX_SHAPE.circle, 0);
			...
			case 1:
				...
				if (attack_frame == 4)
					...
					var _hitbox = create_melee(0, -48, 1.2, 1, 8, 9, 0.8, 8, 90, 3, HITBOX_SHAPE.circle, 0);
					hitbox_set_property(_hitbox, HITBOX_PROPERTY.hit_sfx, snd_hit_strong2);
					hitbox_set_property(_hitbox, HITBOX_PROPERTY.hit_fx_style, HIT_FX.slash);
					var _hitbox = create_melee(-30, -16, 0.9, 1.1, 7, 6, 0.5, 8, 160, 5, HITBOX_SHAPE.circle, 0);
					hitbox_set_property(_hitbox, HITBOX_PROPERTY.hit_fx_style, HIT_FX.slash);
					}
				if (attack_frame == 2)
					{
