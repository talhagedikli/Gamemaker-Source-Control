		...
		switch(_phase)
			...
			case 1:
				...
				if (attack_frame == 0)
					...
					var _hitbox = create_melee(20, 0, 0.8, 0.4, _damage, 5.5, 1.3, 6, 45, 4, HITBOX_SHAPE.square, 0);
					...
					var _hitbox = create_melee(48, 0, 0.8, 0.8, _damage, 5.5, 1.4, 16, 45, 4, HITBOX_SHAPE.circle, 0);
			...
			case 4:
				...
				if (attack_frame == 0)
					...
					var _hitbox = create_melee(24, 0, 0.6, 0.8, _damage, 3, 2, 16, 85, 3, HITBOX_SHAPE.circle, 0);
			...
			case 5:
				...
				if (attack_frame == 4)
					...
					var _hitbox = create_melee(20, -32, 0.6, 0.8, _damage, 3, 1.5, 16, 85, 3, HITBOX_SHAPE.circle, 0);
					_hitbox.hit_fx_style = HIT_FX.normal_medium;
					_hitbox.hit_sfx = snd_hit_strong;
					_hitbox.techable = false;
					}
				...
				if (attack_frame == 2)
					...
					var _hitbox = create_melee(20, -64, 0.5, 0.5, _damage, 5, 0.5, 16, 85, 3, HITBOX_SHAPE.circle, 0);
					_hitbox.hit_fx_style = HIT_FX.normal_medium;
