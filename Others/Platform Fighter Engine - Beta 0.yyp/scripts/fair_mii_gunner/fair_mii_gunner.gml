		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					//Melee hit
					var _hitbox = create_melee(40, 0, 0.7, 0.6, 5, 9, 0.55, 8, 45, 4, HITBOX_SHAPE.circle, 0, FLIPPER.sakurai);
					hitbox_set_property(_hitbox, HITBOX_PROPERTY.hit_fx_style, HIT_FX.normal_medium);
					//Projectile
					var _proj = create_projectile(48, 0, 0.5, 0.5, 8, 6, 0.9, 45, 13, HITBOX_SHAPE.circle, 10, 0);
