		...
		switch(_phase)
			...
			case 0:
				...
				if ((charge >= smash_attack_max_charge || (!button_hold(INPUT.smash) && !button_hold(INPUT.attack) && !button_hold(INPUT.special))) && attack_frame == 0)
					...
					var _hitbox = create_melee(0, 8, 0.8, 0.5, 2, 6, 0, 2, 315, 25, HITBOX_SHAPE.square, 0, FLIPPER.toward_player_center_horizontal);
			...
			case 1:
				...
				if (attack_frame == 2)
					...
					var _hitbox = create_melee(16, 8, 0.9, 0.5, _damage, 9, 1.2, 10, 35, 5, HITBOX_SHAPE.square, 1);
