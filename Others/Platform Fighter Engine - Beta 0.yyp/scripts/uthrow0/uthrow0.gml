		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					attack_phase++;
					attack_frame = 10;
					create_targetbox(32, 8, 0.4, 0.5, 3, 1, 0, 7, 90, 1, HITBOX_SHAPE.square, 0, grabbed_id);
					}
				break;
				}
			...
			case 1:
				...
				if (attack_frame == 8)
					{
					anim_frame = 2;
					var _hitbox = create_melee(32, 4, 0.4, 0.8, 3, 15, 0.75, 5, 95, 9, HITBOX_SHAPE.circle, 1);
