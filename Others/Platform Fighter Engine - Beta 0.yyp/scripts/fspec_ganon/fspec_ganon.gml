function fspec_ganon() {
	//Forward Special
	/*
	- Lunges forward and grabs enemies
	*/
	var run = true;
		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					attack_phase++;
					attack_frame = 15;
					create_detectbox(32, 0, 0.6, 0.6, 15, HITBOX_SHAPE.square, 0);
			...
			case 1:
				...
				//VFX
				create_fx_colored(spr_fspec_ganon_trail, 1, 0, 17, x + 32 * facing, y -15 + dcos(attack_frame * 10) * 15, 2, irandom(360));
			...
			case 3:
				...
				if (attack_frame == 18)
					{
					anim_frame = 15;
					var _hitbox = create_melee(32, -16, 0.5, 0.5, 12, 10, 0, 5, 270, 1, HITBOX_SHAPE.square, 1);
			...
			case 4:
				...
				if (attack_frame == 6)
					{
					anim_frame = 21;
					set_speed(0, 8, true, false);
					}
				
				//VFX
				create_fx_colored(spr_fspec_ganon_trail, 1, 0, 17, x + 38 * facing, y + 28, 2, irandom(360), "FX_Layer_Below");
				
				if (on_ground())
					{
					attack_phase++;
					attack_frame = 20;
					var _hitbox = create_melee(16, 16, 1, 0.4, 15, 5, 1, 15, 60, 4, HITBOX_SHAPE.square, 1);
