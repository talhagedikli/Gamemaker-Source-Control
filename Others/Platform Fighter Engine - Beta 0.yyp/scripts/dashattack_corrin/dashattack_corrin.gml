	...
	if (run)
		...
		switch(_phase)
			...
			case PHASE.start:
				{
				//Animation
				anim_sprite = spr_dashattack_corrin;
				anim_speed = 0;
				anim_frame = 0;
			...
			case 1:
				...
				if (attack_frame % 4 == 0 && attack_frame != 0)
					...
					var _hitbox = create_magnetbox(5, 0, 0.7, 0.3, 1, 1, 32, -5, 15, 3, HITBOX_SHAPE.circle, 0);
				...
				if (attack_frame == 0)
					...
					attack_frame = 8;
					//Final hit
					create_melee(0, 0, 0.7, 0.45, 6, 10, 0.6, 4, 45, 3, HITBOX_SHAPE.circle, 1);
					}
				break;
				}
			//Active -> Endlag
