...
function di_direction(argument0, argument1, argument2) {
	...
	//show_debug_message((angle_difference(_temp, 0) / 90));
	//show_debug_message(to_string("Initial: ", _dir, ", Input: ", _stick_direction, ", DI: ", di, ", Change: ", _dir - di, ", DI Range: ", _dir - _max_di, " to ", _dir + _max_di));
