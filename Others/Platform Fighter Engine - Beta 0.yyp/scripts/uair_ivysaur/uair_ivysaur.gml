		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					var _hitbox = create_melee(2, -50, 1.5, 1.5, 9, 10, 0.4, 8, 90, 4, HITBOX_SHAPE.circle, 0);
					...
					create_fx_colored(spr_fair_samus_burst, 1, 0, 29, x, y - 50, 2, 0);
					}
				break;
				}
			//Active -> Endlag
