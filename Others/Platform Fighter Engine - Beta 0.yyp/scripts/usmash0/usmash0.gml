		...
		switch(_phase)
			...
			case 2:
				...
				if (attack_frame == 1)
					...
					var _damage = calculate_smash_damage(15);
					var _hitbox = create_melee(24, -37, 0.5, 0.9, _damage, 11, 1, 15, 75, 1, HITBOX_SHAPE.circle, 0);
			...
			case 3:
				...
				if (attack_frame == 0)
					...
					var _hitbox = create_melee(-19, -15, 0.8, 1, _damage, 6, 1, 15, 120, 5, HITBOX_SHAPE.circle, 0);
					_hitbox.hit_fx_style = HIT_FX.normal_strong;
					_hitbox.shieldstun_scaling = 0.5;
