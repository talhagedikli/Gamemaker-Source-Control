///@func create_detectbox(rel_x,rel_y,xscale,yscale,lifetime,shape,hitbox_group,[detect_script]);
///@param rel_x
///@param rel_y
///@param xscale
///@param yscale
...
function create_detectbox() {
	...
	with(_newhitbox)
		...
		lifetime = argument[4];
		hitbox_set_property(_newhitbox, HITBOX_PROPERTY.shape, argument[5]);
		owner = other.id;
