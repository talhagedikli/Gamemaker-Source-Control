	...
	if (run && state_frame == 0)
		...
		switch(stored_state)
			...
			case PLAYER_STATE.in_hitstun:
				...
				final_direction = di_direction(kdir, stick_get_direction(Lstick), di_angle);
				...
				if (_current_speed > 15)
					...
					var _fx = create_fx(spr_hit_fx_launch, 1, 0, state_frame div 2, x, y, _scale, _ang, "FX_Layer_Below");
					_fx.follow = id;
					_fx.shrink = 0.9;
