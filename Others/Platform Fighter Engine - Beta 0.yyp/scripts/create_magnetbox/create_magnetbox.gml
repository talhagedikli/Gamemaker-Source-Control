///@func create_magnetbox(rel_x,rel_y,xscale,yscale,damage,hitlag,goal_x,goal_y,magnet_time,lifetime,shape,hitbox_group,[relative]);
///@param rel_x
///@param rel_y
///@param xscale
///@param yscale
...
function create_magnetbox() {
	...
	with(_newhitbox)
		...
		lifetime = argument[9];
		hitbox_set_property(id, HITBOX_PROPERTY.shape, argument[10]);
		owner = other.id;
