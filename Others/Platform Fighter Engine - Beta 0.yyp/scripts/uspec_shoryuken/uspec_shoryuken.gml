		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					{
					anim_frame = 2;
					set_speed(3 * facing, -19, false, false);
					attack_phase++;
					attack_frame = 26;
					var _hitbox = create_melee(16, 0, 0.5, 0.5, 15, 10, 1.1, 17, 80, 1, HITBOX_SHAPE.circle, 0);
			...
			case 1:
				...
				if (attack_frame == 25)
					{
					var _hitbox = create_melee(4, -4, 0.5, 0.9, 7, 8, 0.9, 8, 75, 12, HITBOX_SHAPE.circle, 0);
