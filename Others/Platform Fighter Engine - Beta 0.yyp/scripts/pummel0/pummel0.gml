		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					attack_phase++;
					attack_frame = 3;
					var _hitbox = create_targetbox(20, 5, 0.5, 0.3, 1, 5, 0.1, 8, 75, 4, HITBOX_SHAPE.circle, 0, grabbed_id);
					hitbox_set_property(_hitbox, HITBOX_PROPERTY.knockback_state, PLAYER_STATE.is_grabbed);
					hitbox_set_property(_hitbox, HITBOX_PROPERTY.hit_sfx, snd_hit_slap2);
					}
				break;
				}
			//Pummel Active
