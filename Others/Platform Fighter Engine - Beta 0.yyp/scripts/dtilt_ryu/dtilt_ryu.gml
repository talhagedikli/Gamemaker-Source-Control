		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame <= 4 && !button_hold(INPUT.attack))
					...
					attack_phase = 1;
					attack_frame = 12;
					var _hitbox = create_melee(24, 16, 1.1, 0.3, 2, 3, 0.1, 3, 55, 2, HITBOX_SHAPE.square, 0);
				...
				//Heavy
					...
					attack_phase = 2;
					attack_frame = 21;
					var _hitbox = create_melee(24, 16, 1.1, 0.3, 12, 9, 0.3, 10, 45, 4, HITBOX_SHAPE.square, 0, FLIPPER.sakurai);
					_hitbox.techable = false;
