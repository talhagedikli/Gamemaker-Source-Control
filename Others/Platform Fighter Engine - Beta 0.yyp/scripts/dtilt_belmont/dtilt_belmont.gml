		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame == 0)
					...
					create_melee(10, 18, 0.5, 0.4, 4, 9, 0.6, 15, 75, 4, HITBOX_SHAPE.square, 0);
					//VFX
			...
			case 1:
				...
				if (attack_frame == 15)
					{
					create_melee(10, 18, 0.5, 0.4, 3, 8, 0.5, 15, 75, 13, HITBOX_SHAPE.square, 0);
					}
				//Second part
				if (!attack_has_hit(true, true) &&  button(INPUT.attack, buff))
					{
					//Animation
					anim_frame = 8;
			...
			case 3:
				...
				if (attack_frame == 28)
					...
					create_melee(10, 4, 0.5, 0.4, 5, 8, 0.9, 15, 45, 3, HITBOX_SHAPE.circle, 1);
					}
				if (attack_frame == 26)
					{
					//Animation
					anim_frame = 10;
					create_melee(10, 6, 0.5, 0.4, 5, 6, 0.9, 15, 45, 13, HITBOX_SHAPE.circle, 1);
					}
