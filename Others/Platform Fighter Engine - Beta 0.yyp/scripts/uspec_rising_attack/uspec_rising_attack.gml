		...
		switch(_phase)
			...
			case 0:
				...
				if (attack_frame==0)
					...
					create_melee(16,-8,0.3,0.4,7,7,0.6,1,80,6,HITBOX_SHAPE.square,0);
					}
				break;
				}
			//Active -> Endlag
			case 1:
				...
				if (attack_frame==8)
					...
					create_melee(18,-8,0.3,0.5,5,5,0.5,1,80,18,HITBOX_SHAPE.square,0);
