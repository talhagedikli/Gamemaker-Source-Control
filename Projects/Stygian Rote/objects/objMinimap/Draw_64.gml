...
if (global.showMap) {
	...
	draw_set_color(c_white);
	draw_set_alpha(0.5);
	draw_roundrect_ext(100, 100, GUI_W - 100, GUI_H - 100, 20, 20, false);

	with(objParMinimap) { 
		draw_set_color(c_black);
		draw_set_alpha(1);
		draw_circle(remap(x, 0, room_width, 100, GUI_W - 100), 
					remap(y, 0, room_height, 100, GUI_H - 100), radius, false);
		//draw_point(lerp(0, mapSize, x/room_width), lerp(0, mapSize, y/room_height));
	}	
