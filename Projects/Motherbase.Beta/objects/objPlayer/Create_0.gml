...
/// @description Description for checkCollisions
/// @param {resource.GMObject} [_object=objBlock] description
/// @param {nil} _motion description
/// @param {bool} [_applyspd=true] description
/// @returns {unset} description
function checkCollisions(_object=objBlock, _motion, _applyspd = true)
{
...
/// @description Description for checkOnGround
...
/// @description Description for clampMotion
/// @param {struct} _speedVec description
/// @returns {unset} description
...
/// @description No argumments
/// @returns {unset} description
function checkInWater()
{
    return place_meeting(x - sprite_width * 0.3, y - sprite_height * 0.3, objWater);
}
/// @description Description for applyGravity
/// @param {real} _grav description
/// @returns {unset} description
