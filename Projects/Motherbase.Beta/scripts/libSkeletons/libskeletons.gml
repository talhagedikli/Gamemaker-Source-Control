...
/// @description Description for check_only
...
/// @desc Description for draw_set_aling
/// @param {constant.HAlign} [halign=fa_left] fa_left] description
/// @param {constant.VAlign} [valign=fa_top] fa_top] description
...
/// @description Description for draw_reset_align
/// @returns {unset} description
...
/// @desc Description for draw_set_blend
/// @param {constant} [color=c_white] c_white] description
/// @param {real} [alpha=1] 1] description
...
/// @description Description for draw_reset_blend
/// @returns {unset} description
...
/// @description Description for lengthdir
/// @param {struct} [len=new Vector2(0)] description
/// @param {struct} [dir=new Vector2(0)] description
...
/// @description Description for concat
...
/// @description Description for approach
/// @param {real} _a description
/// @param {real} _b description
...
/// @description Description for wave
/// @param {real} _from description
/// @param {real} _to description
/// @param {real} _duration description
/// @param {real} [_offset=0] description
/// @returns {real} description
...
/// @param {real} _minimum description
/// @param {real} _wrapAt description
/// @returns {unset} description
...
/// @desc Description for normalize
/// @param {real} value description
/// @param {real} _min description
/// @param {real} _max description
function normalize(value, _min, _max)
{
	var nz = (value - _min) / (_max - _min);
	nz = clamp(nz, 0, 1);
	return nz;
}

/// @desc Map(val, min1, max1, min2, max2)
/// @param {real} value description
/// @param {real} min1 description
/// @param {real} max1 description
/// @param {real} min2 description
/// @param {real} max2 description
...
/// @description Description for chance
/// @param {real} _percent description
